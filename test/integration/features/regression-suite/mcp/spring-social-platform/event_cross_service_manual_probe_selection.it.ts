...
test("[IT][execution_orchestration][execute] manual strict probe verification in a multi-probe workspace requires explicit probeId and confirms the trigger line hit", async () => {
