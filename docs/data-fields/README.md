...
| `executionResult.externalVerificationStatus` | External-verification phase aggregate status (`not_configured`, `pass`, `fail`, `blocked`, `skipped_dependency`). | `mcp-java-dev-tools-regression-suite` | false | `"pass"` |
