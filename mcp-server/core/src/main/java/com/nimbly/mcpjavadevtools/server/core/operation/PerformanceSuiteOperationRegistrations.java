...
public final class PerformanceSuiteOperationRegistrations {
    ...
    static OperationRegistration<SuiteOperationArguments, PerformanceSuiteResult> register(
            PerformanceSuiteFeature feature, ObjectMapper mapper) {
        String id = "performance_suite.execute_plan";
        OperationDescriptor descriptor = new OperationDescriptor(
                "performance_suite", "execute_plan", SuiteOperationArguments.class.getName(),
