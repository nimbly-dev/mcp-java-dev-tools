...
test("[IT][artifact_management][run_result] artifact_management run_result cutover is idempotent", async () => {
...
test("[IT][artifact_management][run_result] artifact_management run_result cleanup invokes SQLite retention", async () => {
...
test("[IT][artifact_management][run_result] artifact_management exposes bounded read-only run_state queries", async () => {
...
test("[IT][artifact_management][run_result] artifact_management exposes bounded correlation_state summaries", async () => {
...
test("[IT][artifact_management][run_result] artifact_management exposes active watcher_state progress", async () => {
...
test("[IT][artifact_management][run_result] artifact_management rebuild returns bounded recovery metadata", async () => {
...
test("[IT][artifact_management][run_result] artifact_management rebuild fails closed without canonical sources", async () => {
...
test("[IT][artifact_management][run_result] artifact_management exposes transitional correlation backfill metadata", async () => {
...
test("[IT][artifact_management][run_result] artifact_management audits non-reconstructible legacy backfill entries", async () => {
