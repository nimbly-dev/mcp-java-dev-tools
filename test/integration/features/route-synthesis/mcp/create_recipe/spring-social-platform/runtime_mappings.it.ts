...
test("[IT][route_synthesis][create_recipe] runtime_first resolves request candidate from actuator mappings", async () => {
...
test("[IT][route_synthesis][create_recipe] runtime_first falls back to static synthesis when runtime mappings endpoint is unreachable", async () => {
  const recipe = await createRecipe({
    discoveryPreference: "runtime_first",
...
test("[IT][route_synthesis][create_recipe] runtime_only fails closed when runtime mappings endpoint is unreachable", async () => {
  const recipe = await createRecipe({
