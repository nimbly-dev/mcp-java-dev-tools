...
/** Purpose-owned operations for run-result Artifacts and their state surfaces. */
public final class RunResultOperations {
    private final ArtifactManagementSupport support;

    /** Creates the run-result owner. */
    public RunResultOperations(ArtifactManagementSupport support) {
