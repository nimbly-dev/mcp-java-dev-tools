...
3. **Establish project context.** Resolve the project, plan, suite type, execution profile, target boundary, security mode, knowledge-pack references, and whether Sidecar evidence is required. Treat an ambiguous project or plan as blocked.
