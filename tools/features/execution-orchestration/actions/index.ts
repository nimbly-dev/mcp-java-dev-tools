...
export type ExecutionOrchestrationActionMap = Readonly<
  Record<"execute", typeof executeExecutionOrchestrationAction>
>;
    ...
    case "execute":
      return executeExecutionOrchestrationAction({
        ...
        payload: {
          ...
          ...(typeof args.request.input.suiteRunId === "string"
            ? { suiteRunId: args.request.input.suiteRunId }
            : {}),
