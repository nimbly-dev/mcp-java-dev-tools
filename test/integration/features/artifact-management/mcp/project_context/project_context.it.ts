...
test("[IT][artifact_management][project_context] artifact_management enforces typed envelope and returns project_context summary by default", async () => {
...
test("[IT][artifact_management][project_context] artifact_management project_context creation provisions the run-state store", async () => {
...
test("[IT][artifact_management][project_context] artifact_management project_context validate rejects missing orchestrator defaults", async () => {
...
test("[IT][artifact_management][project_context] artifact_management project_context validate fails closed on absolute envFile", async () => {
  const tmpRoot = await fs.mkdtemp(
...
test("[IT][artifact_management][project_context] artifact_management project_context validate fails closed on missing execution profile plan artifact", async () => {
  const tmpRoot = await fs.mkdtemp(
...
test("[IT][artifact_management][project_context] artifact_management project_context upsert fails closed on unsupported workspace variable mappings and does not persist artifact", async () => {
  const tmpRoot = await fs.mkdtemp(
...
test("[IT][artifact_management][project_context] artifact_management project_context validate returns root inspection for canonical selector inputs", async () => {
  const tmpRoot = await fs.mkdtemp(
