import type {
  SuiteExternalVerificationPhaseStatus,
  SuiteRunStatus,
  SuiteWatcherPhaseStatus,
} from "./suite_run_status.model";
...
export type RuntimeSuiteActivePlanProgressSummary = {
  ...
  triggerStatus?: SuiteRunStatus;
  watcherStatus?: SuiteWatcherPhaseStatus;
  externalVerificationStatus?: SuiteExternalVerificationPhaseStatus;
