...
test("[IT][execution_orchestration][execute] execution_orchestration fails closed when strict probe verification omits probeId in a multi-probe workspace", async () => {
