...
test("[IT][execution_orchestration][execute] execution_orchestration preserves probe.hit across cross-service event trigger and downstream listener verification", async () => {
