...
const featureFlagsControllerFqcn = "com.example.social.post.app.controller.FeatureFlagsController";
...
test("[IT][route_synthesis][create_recipe] route synthesis avoids legacy-default segment when concrete controller mapping is explicit", async () => {
